...
<img src="media/webimages/logo.png" style="width: 220px;">
...
<input type="checkbox" name="password" placeholder="Password" required>Remember me

<a href="#" style="float:right;color: #000;">Forgot Password ?</a>
</div>
...
<a href="#" class="item-btn btn-ghost btn-new" style="width:100%;">Login</a>
</div>
</div>
<div class="col-lg-8 col-md-12 col-sm-12 column">
<div class="form-group text-center" style="margin-top: 20px;">
Don’t have an account? <a href="register.php" style="color: #000;font-weight: 500;">Create an account</a>
</div>
</div>
</div>
</form>
