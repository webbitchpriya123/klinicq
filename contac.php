...
<section class="contact-location-address">
	<div class="container">
		<div class="row">
			<div class="col-lg-4 marg-btm-30">
...
<p class="text-center">1700 W Blancke St, Kiyev Port South Usa, American</p>
...
<h3 class="text-center">Our Email Address</h3>

<p class="text-center">mail@klinicq.com</p>
...
<h3 class="text-center">Our Phone Number</h3>

<p class="text-center">(536) 694-0265</p>
...
<section class="contact-wrap-layout3 section-padding-md-equal">
			<div class="container">
				<div class="row gutters-50 align-items-center">
					<div class="col-lg-6 mb-5 has-animation">
						<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15665.673615203721!2d76.9602456!3d11.0072014!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba8591fc2b091d3%3A0xae8a5f0b335f380a!2sWebbitech!5e0!3m2!1sen!2sin!4v1712898705402!5m2!1sen!2sin" width="100%" height="650" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					</div>
					<div class="col-lg-6 has-animation">
						<div class="heading-dark heading-layout1">
						
						<h2 class="heading-main-title" style="color: rgba(0, 39, 90, 1);">Get in Touch</h2>
...
How can we help?" class="textarea form-control" name="message" id="form-message" rows="5" cols="20"  required></textarea>
...
<label style="font-size: 20px;font-weight: 600;">Services</label> <br>
											<input type="checkbox" id="Hospital" name="Hospital" value="Hospital Mangement">
<label for="Hospital"> Hospital Mangement</label><br>
<input type="checkbox" id="Clinic" name="Clinic" value="Clinic Mangement">
<label for="Clinic"> Clinic Mangement</label><br>
<input type="checkbox" id="User" name="User" value="User Management">
<label for="User"> User Management</label><br>
										</div>
									</div>
<div class="col-12 form-group padd-btm-30">
										<div class="translate-bottom-50 opacity-animation transition-100 transition-delay-2000">

											<input type="checkbox" id="Hospital" name="Hospital" value="Hospital Mangement">
<label for="Hospital" style="font-size: 20px;font-weight: 600;">By signing up, you accept our privacy policy. </label>
										</div>
									</div>
									...
									<div class="col-12 form-group mb-0">
										<div class="translate-bottom-50 opacity-animation transition-100 transition-delay-2200">
											<button type="submit" class="btn-fill btn-gradient fnt-20" style="width:100%;">Send Message</button>
										</div>
									</div>
